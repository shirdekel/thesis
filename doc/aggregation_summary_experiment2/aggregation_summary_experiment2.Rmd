...
Subsequently, we asked participants how many projects they would invest in out of the 10 that they saw. As Figure\ \@ref(fig:plot-portfolio-number) shows, the difference between presentation conditions was not significant, `r results_portfolio_number$presentation`. The awareness effect was also not significant, `r results_portfolio_number$awareness`. However, those that that saw a distribution chose to invest in significantly more projects than those that did not see a distribution, `r results_portfolio_number$distribution`. 
