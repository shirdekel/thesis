...
```{r allocation}
descriptives_aggregation_3$allocation %>% 
...
Figures\ \@ref(fig:plot-choice-binary) and\ \@ref(fig:plot-choice-proportion) show the choice and proportion data, respectively. The difference between similarity conditions was not significant, both in the logistic regression `r results_aggregation_3$choice$full_result[[2]]`, and in the t-test, `r results_aggregation_3$proportion`.
...
We asked participants how many projects they expected to see. As Figure\ \@ref(fig:plot-project-expectation) shows, the difference between presentation conditions was not significant, `r results_aggregation_3$project_expectation`. 
...
Participants were then asked if they would rather invest in all or none of the projects. As Figure\ \@ref(fig:plot-portfolio-binary) shows, the difference between presentation conditions was not significant, `r results_aggregation_3$portfolio_binary$full_result[[2]]`. 
...
Subsequently, we asked participants how many projects they would invest in out of the 10 that they saw. As Figure\ \@ref(fig:plot-portfolio-number) shows, the difference between presentation conditions was not significant, `r results_aggregation_3$portfolio_number`.
