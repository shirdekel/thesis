...
- The below figures show a sample of the possible project displays
  participants will see.
    - The first 16 Figures showcase the experiment materials and order for a
      participant in the combined anecdote condition.
    - The final figure shows an example of a display from the anecdote only
      condition. All that differs here are the instructions.
