...
loadd(starts_with("descriptives_aggregation"))
loadd(starts_with("results_aggregation"))
loadd(starts_with("plot_aggregation"))
loadd(starts_with("gambles_aggregation"))
