...
(ref:plot-aggregation-4-choice) Mean project acceptance for the awareness
effect.
...
(ref:plot-aggregation-4-proportion) Mean proportion of project acceptance for
...
(ref:plot-aggregation-4-choice-trials) Mean project acceptance by awareness and
trial.
...
(ref:plot-aggregation-4-project-expectation) Number of projects participants
expected to see, by awareness.
...
(ref:plot-aggregation-4-project-number) Number of projects participants reported
seeing, by awareness.
...
(ref:plot-aggregation-4-portfolio-binary) Mean choice of investing in all 20
projects for the awareness effect.
...
(ref:plot-aggregation-4-portfolio-number) Mean number of projects chosen in the
follow-up for the awareness effect.
...
Figures\ \@ref(fig:plot-aggregation-4-trials) and\ \@ref(fig:plot-gamble-values) show the
...
(ref:plot-aggregation-4-trials) Mean project acceptance for the 20 gambles. The
...
(ref:plot-aggregation-4-gamble-values) Mean project acceptance for the gambles'
expected value, positive probability, and positive outcome.

```{r plot-gamble-values, fig.cap = "(ref:plot-aggregation-4-gamble-values)"}
