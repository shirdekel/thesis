...
in the expected return on investment. These are the gambles that we investigate
...
primary contributions. First, we are the first to investigate the effect of
choice bracketing on risk aggregation in independent gambles evaluated without
immediate returns. Second, we introduce novel choice bracketing manipulations.
...
promote aggregation in these more realistic decisions. As such, we investigated
...
way, our paradigm is more isometric with real-life risky choice.
...
[^2]: We use the terminology from @bristow2011 and @camilleri2013 for
    consistency.
...
real life, we rarely see the immediate outcomes of our risky choices, and even
...
them individually -- reduced risk aversion. However, we are interested in how
...
In the present study we investigate risky choice in the context of business
project investment internal to a company because this is a real-world context
where choice bracketing is important and currently underutilized [@lovallo2020].
In the current study though, our participants are taken from a general
...
the variables we are researching here are readily applicable to the financial
...
funds. Further, because our task concerns managerial decision-making, we can
