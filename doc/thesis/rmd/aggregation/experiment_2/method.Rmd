...
`r descriptives_aggregation_2$apa` Table\ \@ref(tab:allocation-aggregation-2) shows the condition allocation.
...
[Experiment 1](#task-aggregation-1), but with new gamble values,
in order to fix the mistake in the Experiment 1 gamble value calculation.
