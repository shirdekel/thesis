...
t-test). Figures\ \@ref(fig:plot-aggregation-2-choice) and\ \@ref(fig:plot-aggregation-2-proportion)
...
Further, as Figure\ \@ref(fig:plot-aggregation-2-awareness-trials) shows, it
doesn't seem as if the previous awareness by trial effect was replicated.

(ref:plot-aggregation-2-awareness-trials) Mean project acceptance for separate
presentation, distribution absent condition, by awareness and trial.

```{r plot-aggregation-2-awareness-trials, fig.cap = "(ref:plot-aggregation-2-awareness-trials)"}
