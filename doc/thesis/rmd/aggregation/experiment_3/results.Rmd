...
(ref:plot-aggregation-3-choice) Mean project acceptance for the similarity
effect.
...
(ref:plot-aggregation-3-proportion) Mean proportion of project acceptance for
...
(ref:plot-aggregation-3-choice-trials) Mean project acceptance by similarity and
trial.
...
(ref:plot-aggregation-3-project-expectation) Number of projects participants
expected to see, by similarity.
...
(ref:plot-aggregation-3-project-number) Number of projects participants reported
seeing, by similarity.
...
(ref:plot-aggregation-3-portfolio-binary) Mean choice of investing in all 10
projects for the similarity effect.
...
(ref:plot-aggregation-3-portfolio-number) Mean number of projects chosen in the
follow-up for the similarity effect.
...
Figures\ \@ref(fig:plot-aggregation-3-trials) and\ \@ref(fig:plot-gamble-values) show the
...
(ref:plot-aggregation-3-trials) Mean project acceptance for the 10 gambles. The
...
```{r plot-gamble-values, fig.cap = "(ref:plot-aggregation-3-gamble-values)"}
