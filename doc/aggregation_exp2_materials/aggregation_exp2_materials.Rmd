...
image_read(here("inst", "materials", "instructions.png")) %>% 
        image_trim()
```
...
image_read(here("inst", "materials", "project_number.png")) %>% 
        image_trim()
```

```{r portfolio-binary, out.width = "100%", fig.cap = "Follow-up 2", fig.pos = "H"}
image_read(here("inst", "materials", "portfolio_binary.png")) %>% 
        image_trim()
```

```{r portfolio-number, out.width = "100%", fig.cap = "Follow-up 3", fig.pos = "H"}
image_read(here("inst", "materials", "portfolio_number.png")) %>% 
        image_trim()
```
