  ...
  instructions_raw <-
    list(
      ...
      str_c(
        ...
        "all the case studies to the below target project based on dimensions",
        "such as the overall money invested, the quality of the proposal, the",
        "experience of the managers that proposed it, and the specific",
        "operations that were required. This case study was found to be, on",
        "average, as similar to the target as the others in the sample.",
        "Further, you are also provided with an analysis of this investment",
        "decision after it became clear that the project",
        success[[5]],
