the_plan <-
  drake_plan(
    ...
    trial_aware = get_trial_awareness("You will now see the 10 projects.", "aware"),
    trial_naive = get_trial_awareness("You will now see the projects.", "naive"),
    ...
    trial_joint_distribution_present = get_trial_joint(preamble_distribution_present, questions_joint, "present"),
    trial_joint_distribution_absent = get_trial_joint(preamble_distribution_absent, questions_joint, "absent"),
    trial_separate_distribution_present = get_trial_separate(preamble_distribution_present, project_description, form_options, project_input, "present"),
    trial_separate_distribution_absent = get_trial_separate(preamble_distribution_absent, project_description, form_options, project_input, "absent"),
